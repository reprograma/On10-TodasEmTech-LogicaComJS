...
//alert("A soma dos seus dois nuumeros é:" + soma);
...
console.log(`O valor do jantar é: ${valorJantar}, o valor da taxa de serviço é de ${taxaDeServico*100}% e o valor final é de ${valorFinal}`); */
