...
/*
  1. Crie um algoritmo, que solicite ao usuário dois valores, calcule 
  a soma desses números e mostre o resultado em um alerta.
...
/*
  2. Crie um algoritmo que leia o valor de um jantar,
...
//console.log(`O valor do jantar é: R$${valorJantar}, o valor da taxa de serviço é de: 
//${taxaDeServico * 100}% e o valor final é de: R$${valorFinal}`);
