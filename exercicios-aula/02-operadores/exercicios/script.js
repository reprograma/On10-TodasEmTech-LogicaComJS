...
//alert(`a soma dos seus valores é ${soma}`);
...
//console.log(`O valor do jantar é R$${valorJantar}, o valor da taxa de serviço é de ${taxadeServico*100}% e o valor final é de RS${valorFinal}`);
