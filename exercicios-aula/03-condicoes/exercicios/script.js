...
switch(numeroEscolhido){
  case "1"
  alert(`O dia corresponde ao número ${numeroEscolhido} é domingo.`)
  break;
  case "2"
  alert(`O dia corresponde ao número ${numeroEscolhido} é segunda.`)
  break;
  case "3"
  alert(`O dia corresponde ao número ${numeroEscolhido} é terça.`)
  break;
  case "4"
  alert(`O dia corresponde ao número ${numeroEscolhido} é quarta.`)
  break;
  case "5"
  alert(`O dia corresponde ao número ${numeroEscolhido} é quinta.`)
  break;
  case "6"
  alert(`O dia corresponde ao número ${numeroEscolhido} é sexta.`)
  break;
  case "7"
  alert(`O dia corresponde ao número ${numeroEscolhido} é sábado.`)
  break;
  default:
