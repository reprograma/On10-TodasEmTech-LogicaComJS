...
console.log('A variável mensagem é do tipo: ',
    typeof(mensagem));
console.log('A variável anoNascimento é do tipo: ',
    typeof(anoNascimento));
console.log('A variável anoDeNascimento é do tipo: ',
    typeof(anoDeNascimento));
console.log('A variável gostoDeProgramar é do tipo: ',
    typeof(gostoDeProgramar));