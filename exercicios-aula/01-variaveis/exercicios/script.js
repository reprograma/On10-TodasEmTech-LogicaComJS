...
const anoDeNascimento = "1987";
//console.log (anoDeNascimento);
  

 /* 4. Declare uma variável chamada
  `gostoDeProgramar`, atribuindo à ela o valor booleano que representa `verdadeiro` e exiba no console. */
...
console.log("tipo da variavel mensagem:", typeof mensagem)
console.log("tipo da variavel anoNascimento:", typeof anoNascimento)
console.log("tipo da variavel anoDeNascimento:", typeof anoDeNascimento)
console.log("tipo da variavel gostoDeProgramar:", typeof gostoDeProgramar)
