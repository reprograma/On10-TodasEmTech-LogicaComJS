...
console.log("tipo de anoNascimento:", typeof(anoNascimento));
console.log("tipo de anoDeNAscimento:", typeof(anoDeNascimento));
console.log("tipo de gostoDeProgramar:", typeof(gostoDeProgramar));
