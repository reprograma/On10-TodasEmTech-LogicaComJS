...
function calcularPreferenciaCombustivel(){
    ...
    while(codigoCombustivel!=4){
        ...
        alert (`MUITO OBRIGADO. Quantidade de abastecimento(s) do álcool: ${preferenciaAlcool}, quantidade de abastecimento(s) da gasolina: ${preferenciaGasolina}, quantidade de abastecimento(s) do diesel: ${preferenciaDiesel}.`);
        codigoCombustivel = Math.abs(parseInt(prompt('Qual o código do combustível abastecido por você?')))
    }
};
