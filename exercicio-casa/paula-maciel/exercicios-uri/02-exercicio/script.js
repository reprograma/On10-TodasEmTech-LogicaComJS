...
while (entrada == 1 || entrada == 2 || entrada == 3 || entrada == 4) {
    ...
    let entrada = prompt("Qual é o combustivel de sua preferência? 1. Álcool | 2. Gasolina | 3. Diesel");
    if (entrada == 1) {
        console.log("Álcool:");
        alcool ++
    } else if (entrada ==  2) {
...
alert(`MUITO OBRIGADA! Total: ${alcool} Álcool, ${gasolina} Gasolina, ${diesel} Diesel.`)
